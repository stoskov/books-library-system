...
namespace BooksLibrarySystem.Web.Controls.ErrorSuccessNotifier
{
	...
	public class NotificationMessage
	{
		...
		public BooksLibrarySystem.Web.Controls.ErrorSuccessNotifier.MessageType Type { get; set; }
	...
	public partial class ErrorSuccessNotifier : System.Web.UI.UserControl
	{
		...
		public static void AddMessage(BooksLibrarySystem.Web.Controls.ErrorSuccessNotifier.NotificationMessage msg)
		{
			List<BooksLibrarySystem.Web.Controls.ErrorSuccessNotifier.NotificationMessage> messages = NotificationMessages;
			if (messages == null)
			{
				messages = new List<BooksLibrarySystem.Web.Controls.ErrorSuccessNotifier.NotificationMessage>();
			}
			messages.Add(msg);
		...
		private static List<BooksLibrarySystem.Web.Controls.ErrorSuccessNotifier.NotificationMessage> NotificationMessages
		{
			get
			{
				List<BooksLibrarySystem.Web.Controls.ErrorSuccessNotifier.NotificationMessage> messages = (List<BooksLibrarySystem.Web.Controls.ErrorSuccessNotifier.NotificationMessage>)
		...
		{
			AddMessage(new BooksLibrarySystem.Web.Controls.ErrorSuccessNotifier.NotificationMessage()
			{
				Text = msg,
				Type = BooksLibrarySystem.Web.Controls.ErrorSuccessNotifier.MessageType.Info,
				AutoHide = true
			});
		}
		...
		public static void AddSuccessMessage(string msg)
		{
			...
			{
				Text = msg,
				Type = BooksLibrarySystem.Web.Controls.ErrorSuccessNotifier.MessageType.Success,
				AutoHide = true
			});
		}
		...
		public static void AddWarningMessage(string msg)
		{
			...
			{
				Text = msg,
				Type = BooksLibrarySystem.Web.Controls.ErrorSuccessNotifier.MessageType.Warning,
				AutoHide = false
			});
		}
		...
		public static void AddErrorMessage(string msg)
		{
			...
			{
				Text = msg,
				Type = BooksLibrarySystem.Web.Controls.ErrorSuccessNotifier.MessageType.Error,
				AutoHide = false
			});
		}
