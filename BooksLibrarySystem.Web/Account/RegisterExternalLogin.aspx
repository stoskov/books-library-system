<%@ Page Title="Register an external login" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegisterExternalLogin.aspx.cs" Inherits="BooksLibrarySystem.Web.Account.RegisterExternalLogin" Async="true" %>
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
	<header>
		<h1>Register with your <%: this.ProviderName %> account</h1>
	</header>
	...
	<asp:PlaceHolder runat="server" >
		<fieldset class="form-horizontal">
			...
			<p class="text-info">
				You've authenticated with <strong><%: this.ProviderName %></strong>. Please enter a user name below for the current site
