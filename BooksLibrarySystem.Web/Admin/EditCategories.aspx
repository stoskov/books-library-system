<%@ Page Title="Edit Categories" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditCategories.aspx.cs" Inherits="BooksLibrarySystem.Web.Admin.EditCategories" %>
    ...
    <div class="row">
        ...
        <div class="span12">
            ...
            <asp:GridView ID="GridViewCategories" runat="server" ItemType="BooksLibrarySystem.Models.Category" CssClass="gridview"
                AutoGenerateColumns="False" DataKeyNames="CategoryId" PageSize="5" AllowPaging="true" AllowSorting="true"
